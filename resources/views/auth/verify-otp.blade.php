...
<head>
    ...
    <title>Verifikasi OTP - Sistem Sekolah</title>
        ...
        <form action="{{ route('password.otp.verify') }}" method="POST" class="space-y-5">
            ...
            <div>
                <input type="text"
                       ...
                       maxlength="6"
                       class="w-full px-4 py-3 rounded-lg bg-black/30 border border-cyan-500 placeholder-cyan-300 text-white transition text-center text-xl tracking-widest"
                       required autofocus>
                @error('otp')
